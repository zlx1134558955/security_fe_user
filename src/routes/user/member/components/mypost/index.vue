<template>
    <div class="content">
        <div>
            <div class="num-box">
                <div class="logo"><i class="el-icon-document"></i></div>
                <p class="info">我提交的漏洞<span class="num">{{ num }}</span>个</p>
            </div>
